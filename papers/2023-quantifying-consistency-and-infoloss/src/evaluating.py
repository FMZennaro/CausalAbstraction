...
class AbstractionErrorEvaluator(AbstractionEvaluator):
    ...
    def compute_overall_error(self, metric=None, J=None,J_algorithm=None, verbose=False):
        return self.evaluate_overall_abstraction_error(metric=metric, J=J,J_algorithm=J_algorithm, verbose=verbose)
